...
class ProvidersResource(Resource):
    ...
    def get(self, organization_id, args):
        ...
        abort(HTTPStatus.NOT_FOUND,
              message="No matching provider found: {}".format(args))
        ...
        try:
            if args:
                ...
                abort(HTTPStatus.NO_CONTENT,
                      message="Nil or invalid provider organization data passed")
    ...
    def put(self, args):
        try:
            ...
            if org_matches:
                ...
                abort(HTTPStatus.NOT_FOUND, message="None found: provider with id {}".format(
                    args.get('id')))
    ...
    def delete(self, args):
        try:
            ...
            if org_matches:
                org = org_matches.pop()
                org.delete()
                deleted = "Successfully deleted: organization {}".format(
                    args.get('id'))
...
class ProgramsResource(Resource):
    ...
    def get(self, args):
        ...
        abort(HTTPStatus.NOT_FOUND,
              message="No matching programs found: {}".format(args))
    ...
    def post(self, args):
        try:
            if args:
                ...
                abort(HTTPStatus.NO_CONTENT,
                      message="Nil or invalid program data passed")
    ...
    def put(self, args):
        try:
            ...
            if program_matches:
                ...
                abort(HTTPStatus.NOT_FOUND, message="None found: program with id {}".format(
                    args.get('id')))
    ...
    def delete(self, args):
        try:
            ...
            if program_matches:
                program = program_matches.pop()
                program.delete()
                deleted = "Successfully deleted: program {}".format(
                    args.get('id'))
                return create_response({"message": deleted}, schema=None, status=HTTPStatus.ACCEPTED)
            else:
                abort(HTTPStatus.NOT_FOUND, message="None found: program with id {}".format(
...
class ServicesResource(Resource):
    ...
    def get(self, args):
        ...
        abort(HTTPStatus.NOT_FOUND,
              message="No matching services found: {}".format(args))
    ...
    def post(self, args):
        try:
            if args:
                ...
                abort(HTTPStatus.NO_CONTENT,
                      message="Nil or invalid service data passed")
    ...
    def put(self, args):
        try:
            ...
            if service_matches:
                ...
                abort(HTTPStatus.NOT_FOUND, message="None found: service with id {}".format(
                    args.get('id')))
    ...
    def delete(self, args):
        try:
            ...
            if service_matches:
                service = service_matches.pop()
                service.delete()
                deleted = "Successfully deleted: service {}".format(
                    args.get('id'))
                return create_response({"message": deleted}, schema=None, status=HTTPStatus.ACCEPTED)
            else:
                abort(HTTPStatus.NOT_FOUND, message="None found: service with id {}".format(
